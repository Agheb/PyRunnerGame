...
class PyrunnerServer(MastermindServerTCP):
    ...
    def callback_connect(self):
        ...
        return super(PyrunnerServer, self).callback_connect()

    def callback_disconnect(self):
        # Something could go here
        return super(PyrunnerServer, self).callback_disconnect()

    def callback_connect_client(self, connection_object):
        # Something could go here
        return super(PyrunnerServer, self).callback_connect_client(connection_object)

    def callback_disconnect_client(self, connection_object):
        # Something could go here
        return super(PyrunnerServer, self).callback_disconnect_client(connection_object)

    def callback_client_receive(self, connection_object):
        # Something could go here
        return super(PyrunnerServer, self).callback_client_receive(connection_object)
    ...
    def callback_client_send(self, connection_object, data, compression=None):
        # Something could go here
        return super(PyrunnerServer, self).callback_client_send(connection_object, data, compression)
